...
/// Base class for Build Doctor log analysis rules.
abstract class DiagnosticRule {
  ...
  /// Diagnostic category for findings generated by this rule.
  DiagnosticCategory get category;

  /// Default severity assigned to findings.
  DiagnosticSeverity get defaultSeverity;

  /// Default confidence score assigned to findings.
  DiagnosticConfidence get defaultConfidence;

  /// Explanatory summary of the likely root cause.
  String get likelyCause;

  /// List of actionable fix recommendations.
  List<String> get recommendations;

  /// Whether findings from this rule can be classified as primary root causes.
  bool canBePrimary;

  /// Whether findings from this rule can be classified as cascading symptoms.
  bool canBeCascading;

  /// Creates a new [DiagnosticRule] instance.
  DiagnosticRule({this.canBePrimary = true, this.canBeCascading = false});

  /// Evaluates log inputs and returns a [DiagnosticFinding] if matched.
  DiagnosticFinding? match(NormalizedLog log, ParsedLogOutput parsed);
}

/// Catalog of all built-in build diagnostic rules.
class DiagnosticRuleCatalog {
  const DiagnosticRuleCatalog._();

  /// Comprehensive list of all active build diagnostic rules.
